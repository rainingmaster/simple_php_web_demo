...
<body>
<?php		
$ripng_net =$_POST['ripng_net'];
$Board_IP =$_GET['Board_IP'];
snmp_set_quick_print(1);
snmpset($Board_IP,"public",".1.3.6.1.2.1.317.1.2.0","s","1|router ripng");
snmpset($Board_IP,"public",".1.3.6.1.2.1.317.1.2.0","s","2|network $ripng_net");
