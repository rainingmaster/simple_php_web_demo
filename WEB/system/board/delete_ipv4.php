...
<title>delete ipv4</title>
</head>
<body>
<?php
$ipv4_delete  = $_POST['ipv4_delete'];
$piecesconf =  explode("+",$ipv4_delete);
$Board_IP = $_GET['Board_IP'];
$board_index = $_GET['board_index'];
snmp_set_quick_print(1);
snmpset($Board_IP,"public",".1.3.6.1.2.1.4.24.9.2.0","s","1|interface $piecesconf[0]");
snmpset($Board_IP,"public",".1.3.6.1.2.1.4.24.9.2.0","s","3|no ip address $piecesconf[1]");
