...
<?php
	...
	{
		?>
			<li><a href="voltage_information.php?ipmb=<?php echo $liveDevice[$n]->Ipmc->Ipmb_addr; ?>&name=<?php echo substr($liveDevice[$n]->Ipmc->Str_name, 1, -1); ?>" target="frame6" ><?php echo substr($liveDevice[$n]->Ipmc->Str_name, 1, -1); ?></a></li>
		<?php
	}
?>
</ul>
