...
$ospfv6_delete_interface =$_POST['ospfv6_delete_interface'];
$piecesconf=explode("+",$ospfv6_delete_interface);
snmp_set_quick_print(1);
snmpset($Board_IP,"public",".1.3.6.1.2.1.191.3.2.0","s","1|router ospf6");
snmpset($Board_IP,"public",".1.3.6.1.2.1.191.3.2.0","s","2|no interface $piecesconf[0] area $piecesconf[1]");
